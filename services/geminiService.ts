...
**قانون اصلی: ابتدا نوع محصول را تشخیص دهید (مثلاً خوراکی، آرایشی، بهداشتی، الکترونیکی). سپس، فقط بخش‌های مرتبط با آن محصول را از لیست زیر انتخاب کرده و برای هر بخش یک ایموجی مناسب و منطقی با عنوان آن انتخاب کنید.**
تمام بخش‌ها باید بسیار کوتاه و مختصر باشند. هر بخش باید با یک تگ \`<hr />\` از بخش بعدی جدا شود.

**1. پاراگراف مقدمه (الزامی):**
...
**2. لیست بخش‌های قابل انتخاب (حداقل ۳ مورد از مرتبط‌ترین‌ها را انتخاب کنید):**
*   **ویژگی‌های کلیدی:** (برای همه محصولات مناسب است)
    *   عنوان: \`<strong>[ایموجی مناسب مانند ✨ یا ✅] ویژگی‌های کلیدی</strong>\`
    *   شامل ۲ تا ۳ ویژگی اصلی محصول.
*   **روش مصرف / طرز استفاده:** (برای محصولات آرایشی، بهداشتی، دارویی یا ابزارها)
    *   عنوان: \`<strong>[ایموجی مناسب مانند 💡 یا 🧴] روش مصرف</strong>\`
*   **پیشنهاد مصرف:** (فقط و فقط برای محصولات خوراکی)
    *   عنوان: \`<strong>[ایموجی مناسب مانند 🍽 یا 🥗] پیشنهاد مصرف</strong>\`
*   **روش نگهداری:** (برای محصولات خوراکی، دارویی یا حساس به شرایط محیطی)
    *   عنوان: \`<strong>[ایموجی مناسب مانند 🧊 یا 📌] روش نگهداری</strong>\`
*   **مشخصات محصول:** (برای همه محصولات مناسب است)
    *   عنوان: \`<strong>📦 مشخصات محصول</strong>\`
    *   شامل برند، وزن، کشور مبدا و...
*   **نکات مهم / هشدارها:** (برای محصولاتی که نکته ایمنی یا آلرژی‌زا دارند)
    *   عنوان: \`<strong>[ایموجی مناسب مانند ⚠️ یا 🟢] نکات مهم</strong>\`

**مثال برای کرم صورت:** خروجی باید شامل بخش "روش مصرف" (با ایموجی 🧴) باشد و **نباید** شامل "پیشنهاد مصرف" (با ایموجی 🍽) باشد.
**مثال برای محصول خوراکی:** خروجی باید شامل "پیشنهاد مصرف" و "روش نگهداری" باشد.
---
