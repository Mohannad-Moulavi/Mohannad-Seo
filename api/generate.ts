...
1.  **توضیحات کامل محصول (\`fullDescription\`):**
    ...
    *   **الزام مهم:** متن نهایی باید **حداقل ۳۵۰ کلمه** باشد تا استانداردهای Yoast SEO را برآورده کند. این یک قانون قطعی است.
    *   **دستورالعمل ویژه برای آجیل و خشکبار:** با توجه به اینکه این محصول آجیل یا خشکبار است، یک متن توصیفی بسیار بلند، جذاب، داستانی و جامع بنویس. از ساختار لیستی با ایموجی (✅, ✨) و تگ های <hr> استفاده **نکن**، اما می‌توانی برای خوانایی بهتر، بخش‌های مختلف را با عناوین **bold** شده از هم جدا کنی.
    *   **از اطلاعات زیر به عنوان منبع اصلی استفاده کن:**
        *   توضیحات مختصر کاربر: "${briefDescription || 'وجود ندارد'}"
    *   **ساختار الزامی و دقیق متن:**
        *   **مقدمه داستانی (حدود ۵۰ کلمه):** با یک مقدمه جذاب و گیرا شروع کن. محصول را معرفی کن، به خاستگاه یا تاریخچه آن اشاره‌ای کوتاه کن و نام محصول را **bold** کن.
        *   **سفری به خاستگاه (حدود ۸۰ کلمه):** به طور مفصل در مورد منطقه کشت و اصالت محصول بنویس. ویژگی‌های جغرافیایی یا فرهنگی که این محصول را خاص می‌کند را توصیف کن.
        *   **تجربه طعم و عطر (حدود ۷۰ کلمه):** طعم، بافت، و عطر محصول را با جزئیات دقیق و وسوسه‌انگیز توصیف کن. از صفات توصیفی غنی استفاده کن.
        *   **گنجینه‌ای از خواص (حدود ۱۰۰ کلمه):** خواص و فواید محصول برای سلامتی را به تفصیل شرح بده. به ویتامین‌ها، مواد معدنی، و تاثیرات مثبت آن بر بدن اشاره کن. این بخش باید بسیار کامل باشد.
        *   **همراه لحظه‌های شما (حدود ۵۰ کلمه):** کاربردهای مختلف محصول را بیان کن. از مصرف به عنوان میان‌وعده تا استفاده در آشپزی، شیرینی‌پزی یا همراهی با نوشیدنی‌های مختلف.
        *   **نتیجه‌گیری و دعوت به خرید (حدود ۳۰ کلمه):** با یک پاراگراف کوتاه و یک فراخوان به اقدام (Call to action) قوی و متقاعدکننده برای خرید، متن را به پایان برسان.
    *   متن باید روان و یکپارچه باشد و حس کیفیت و اصالت را به خواننده منتقل کند. **تکرار می‌کنم، طول کل متن باید حتماً بالای ۳۵۰ کلمه باشد.**`;
