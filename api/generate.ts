...
ساختار باید **دقیقاً** به ترتیب زیر باشد. هر بخش با یک تیتر \`<h5>\` که شامل ایموجی و متن است شروع می‌شود و با یک جداکننده \`<hr class="mohannad-divider">\` به پایان می‌رسد.

1.  **<h5>1️⃣ معرفی کوتاه محصول</h5>**
    <p>یک پاراگراف مقدمه جذاب با طول ۳۰ تا ۴۰ کلمه که شامل کلیدواژه کانونی است.</p>
    <hr class="mohannad-divider">

2.  **<h5>✅ مشخصات کلی و مبدأ تولید</h5>**
    <ul>
...
5.  **<h5>🍽️ پیشنهاد مصرف</h5>** (**اختیاری و فقط در صورت لزوم**)
...
8.  **<h5>⚠️ نکات مهم / هشدارها</h5>** (**اختیاری و فقط در صورت لزوم**)
