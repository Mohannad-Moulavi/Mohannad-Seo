...
const productSchema = {
  ...
  properties: {
    ...
    fullDescription: {
      type: Type.STRING,
      description: "توضیحات کامل محصول با فرمت HTML دقیقاً مطابق ساختار درخواستی در پرامپت. این توضیحات باید با یک پاراگراف مقدمه شروع شود و شامل نام محصول نباشد. بخش‌های مختلف باید با تگ <hr> جدا شوند.",
    },
    seoTitle: {
      type: Type.STRING,
    ...
    keyphraseSynonyms: {
      ...
      description: "آرایه‌ای از ۳ تا ۵ عبارت کلیدی مترادف یا مرتبط برای بخش 'Advanced SEO Analysis'.",
    },
  },
  required: ["correctedProductName", "englishProductName", "fullDescription", "seoTitle", "slug", "focusKeyword", "metaDescription", "keyphraseSynonyms"],
};
...
1.  **توضیحات کامل محصول (\`fullDescription\`):**
    *   این فیلد باید حاوی کد **HTML** تمیز و ساختاریافته باشد. **مهم: این فیلد نباید شامل نام محصول باشد.**
    *   **ساختار الزامی و دقیق:**
        *   **پاراگراف مقدمه:** با یک پاراگراف کوتاه (۲-۳ جمله)، جذاب و شامل کلیدواژه کانونی شروع شود.
...
6.  **تجزیه و تحلیل سئو برتر (\`keyphraseSynonyms\`):**
    *   آرایه‌ای از ۳ تا ۵ عبارت مرتبط یا مترادف.
