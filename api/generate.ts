...
1.  **توضیحات کامل محصول (\`fullDescription\`):**
    ...
    *   **ساختار الزامی و دقیق:**
        ...
        *   **بخش‌ها:** هر بخش باید با یک تیتر \`<h4>\` شروع شود و محتوای آن مختصر باشد (نهایتاً ۲–۳ خط یا ۲–۴ بولت در یک \`<ul>\`).
          *   تیتر \`<h4>ویژگی‌های اصلی</h4>\` و یک لیست بالت (\`<ul>\`) از ویژگی‌ها.
          *   تیتر \`<h4>مزایای استفاده</h4>\` و یک لیست بالت از مزایا.
          *   تیتر \`<h4>طریقه مصرف</h4>\` (فقط اگر مرتبط است).
          *   تیتر \`<h4>مناسب چه کسانی‌ست؟</h4>\`.
          *   تیتر \`<h4>مشخصات محصول</h4>\` (شامل برند، وزن، بسته‌بندی، کشور سازنده و غیره).
          *   تیتر \`<h4>نکات مهم</h4>\`.`;
