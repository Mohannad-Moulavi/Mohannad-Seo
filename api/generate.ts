...
const productSchema = {
  ...
  properties: {
    ...
    fullDescription: {
      type: Type.STRING,
      description: "توضیحات کامل محصول با فرمت HTML. این توضیحات باید با یک پاراگراف مقدمه جذاب شروع شود که شامل نام محصول به صورت **bold** است. بخش‌های مختلف باید با تگ <h2> جدا شوند.",
    },
    shortDescription: {
        type: Type.STRING,
...
1.  **توضیحات کامل محصول (\`fullDescription\`):**
    ...
    *   **قوانین نگارشی برای سئو (بسیار مهم):**
        *   **استفاده از تیتر:** برای هر بخش از متن از تگ تیتر \`<h2>\` به همراه یک ایموجی مناسب استفاده کن. این یک الزام است.
...
1.  **توضیحات کامل محصول (\`fullDescription\`):**
    ...
    *   **قوانین نگارشی برای سئو (بسیار مهم):**
        *   **استفاده از تیتر:** برای هر بخش از متن از تگ تیتر \`<h2>\` به همراه ایموجی مربوطه استفاده کن. این یک الزام است.
