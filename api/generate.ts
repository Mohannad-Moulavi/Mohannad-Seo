...
1.  **توضیحات کامل محصول (\`fullDescription\`):**
    ...
    *   **دستورالعمل ویژه برای آجیل و خشکبار:** با توجه به اینکه این محصول آجیل یا خشکبار است، یک متن توصیفی بلند، جذاب و داستانی بنویس. از ساختار لیستی با ایموجی (✅, ✨) و تگ های <hr> استفاده **نکن**.
    *   **از اطلاعات زیر به عنوان منبع اصلی استفاده کن:**
        *   توضیحات مختصر کاربر: "${briefDescription}"
    *   **ساختار پیشنهادی متن:**
        *   **مقدمه:** محصول را معرفی کن، به خاستگاه یا محبوبیت آن اشاره کن. نام محصول را **bold** کن.
        *   **بدنه اصلی:** درباره طعم، ظاهر، انواع مختلف (در صورت وجود)، و موارد مصرف آن بنویس. به خواص و فواید آن برای سلامتی اشاره کن.
        *   **نتیجه‌گیری:** با یک پاراگراف کوتاه و یک فراخوان به اقدام (Call to action) برای خرید، متن را به پایان برسان.
    *   متن باید روان و یکپارچه باشد و حس خوبی به خواننده منتقل کند.`;
